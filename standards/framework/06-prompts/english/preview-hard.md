...
- Stress + IPA for any 2+-syllable target word with non-initial stress or known UZ/RU mis-stress (G7+ only).
- Inline SVG strongly encouraged here: past/present/future timeline bridge, sentence-diagram tree (subject/verb/object), or stress-dot IPA chart (Ooo / oOoo rendered as actual dots).
- 8–10 sentences
...
- At least one example must demonstrate the Card 2 rule in action.
...
Structure: 2–3 mini-cases, building in complexity.
...
- Last case: two possible patterns, student must choose the correct one
...
- Avg sentence: G5–6: 9–12 words | G7–8: 12–15 words | G9–10: 15–20 words | G11: 18–25 words.
- Tenses: grade-allowed set only. Never a banned tense — not even in examples.
- UZ↔EN bridge MANDATORY on Panels 2, 5, 7 at minimum. G5–6: every panel.
- Stress + IPA: mandatory G7+ for any 2+-syllable word with non-initial stress or known UZ/RU mis-stress.
