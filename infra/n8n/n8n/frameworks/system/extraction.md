...
- `worked_examples` (array of `{problem, solution, source_location}`) — every solved example
- `figures` (array of `{caption, description, source_location}`) — figures/diagrams/tables described in text (you do not reproduce images)
