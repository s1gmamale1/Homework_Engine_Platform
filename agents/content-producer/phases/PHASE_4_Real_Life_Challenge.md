...
- standards/system/narrative/task_injections.json — Wise Status injections
- standards/library/subject-family/{Family}/{Subject}/{Subject}_Subject_Framework.md — professional roles list
---
