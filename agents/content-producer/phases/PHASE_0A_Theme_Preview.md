...
- standards/system/narrative/quotes_database.json — Gate quote selection
- standards/system/narrative/Bilarmidingiz_faktlar.md — Background facts
- standards/library/subject-family/{Family}/{Subject}/{Subject}_Subject_Framework.md — Phase 0-A Panel Construction Guide section
---
