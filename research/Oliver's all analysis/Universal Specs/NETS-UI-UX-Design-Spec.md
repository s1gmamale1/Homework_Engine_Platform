...
Applies To: Implementation teams building the student-facing app. Framework spec (NETS-Homework-Engine-UNIFIED.md) and session logic (NETS-Homework-Engine-Blueprint.docx) remain the authoritative rules; this doc defines *how it looks and feels*.
